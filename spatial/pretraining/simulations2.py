...
def climate_simulations(train_x, exp):
    ...
    with open('spatial/results/gamTair', 'rb') as f:
        gamTair = pickle.load(f)
    with open('spatial/results/gamPrecip', 'rb') as f:
        gamPrecip = pickle.load(f)
    with open('spatial/results/gamVPD', 'rb') as f:
        gamVPD = pickle.load(f)
    with open('spatial/results/gamPAR', 'rb') as f:
        gamPAR = pickle.load(f)    
    with open('spatial/results/gamfapar', 'rb') as f:
...
def gen_simulations(n, fix_pars = True, data_use = 'full', exp = None, data_dir = 'data/'):
    ...
    with open('spatial/results/gamTair', 'wb') as f:
        pickle.dump(gamTair, f)
    with open('spatial/results/gamPrecip', 'wb') as f:
        pickle.dump(gamPrecip, f)
    with open('spatial/results/gamVPD', 'wb') as f:
        pickle.dump(gamVPD, f)
    with open('spatial/results/gamPAR', 'wb') as f:
        pickle.dump(gamPAR, f)
    with open('spatial/results/gamfapar', 'wb') as f:
        pickle.dump(gamfapar, f)

    #if not fix_pars:
    p = parameter_samples(n_samples = n, fix_pars = fix_pars)
    pdd = pd.DataFrame(p)
    pdd.to_csv('spatial/results/DA_parameter_samples.csv', index=False)
    ...
    d = pd.concat(d)
    d.to_csv(f'spatial/results/simulations_{data_use}_{exp}_{n}.csv', index=False)
