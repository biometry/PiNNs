...
with autograd.detect_anomaly():
    ...
    PAR = torch.tensor(data['PAR'][0:leng], requires_grad=False)
    TAir = torch.tensor(data['Tair'][0:leng], requires_grad=False)
    ...
    p1 = torch.tensor(413., requires_grad=True, dtype=torch.float64)
    p2 = torch.tensor(0.45, requires_grad=True, dtype=torch.float64)
    p3 = torch.tensor(0.118, requires_grad=True, dtype=torch.float64)
    p4 = torch.tensor(3., requires_grad=True, dtype=torch.float64)
    p5 = torch.tensor(0.7457, requires_grad=True, dtype=torch.float64)
    p6 = torch.tensor(10.93, requires_grad=True, dtype=torch.float64)
    p7 = torch.tensor(-3.063, requires_grad=True, dtype=torch.float64)
    p8 = torch.tensor(17.72, requires_grad=True, dtype=torch.float64)
    p9 = torch.tensor(-0.1027, requires_grad=True, dtype=torch.float64)
    p10 = torch.tensor(0.03673, requires_grad=True, dtype=torch.float64)
    p11 = torch.tensor(0.7779, requires_grad=True, dtype=torch.float64)
    p12 = torch.tensor(0.5, requires_grad=True, dtype=torch.float64)
    p13 = torch.tensor(-0.364, requires_grad=True, dtype=torch.float64)
    p14 = torch.tensor(0.2715, requires_grad=True, dtype=torch.float64)
    p15 = torch.tensor(0.8351, requires_grad=True, dtype=torch.float64)
    p16 = torch.tensor(0.07348, requires_grad=True, dtype=torch.float64)
    p17 = torch.tensor(0.9996, requires_grad=True, dtype=torch.float64)
    p18 = torch.tensor(0.4428, requires_grad=True, dtype=torch.float64)
    p19 = torch.tensor(1.2, requires_grad=True, dtype=torch.float64)
    p20 = torch.tensor(0.33, requires_grad=True, dtype=torch.float64)
    p21 = torch.tensor(4.970496, requires_grad=True, dtype=torch.float64)
    p22 = torch.tensor(0., requires_grad=True, dtype=torch.float64)
    p23 = torch.tensor(0., requires_grad=True, dtype=torch.float64)
    p24 = torch.tensor(160., requires_grad=True, dtype=torch.float64)
    p25 = torch.tensor(0., requires_grad=True, dtype=torch.float64)
    p26 = torch.tensor(0., requires_grad=True, dtype=torch.float64)
    p27 = torch.tensor(0., requires_grad=True, dtype=torch.float64)
    p28 = torch.tensor(-999., requires_grad=True, dtype=torch.float64)
    p29 = torch.tensor(-999., requires_grad=True, dtype=torch.float64)
    p30 = torch.tensor(-999., requires_grad=True, dtype=torch.float64)
