...
def eval2res(data_use='full', of=False, v=2):
    ...
    pd.DataFrame.from_dict(preds_train).to_csv(f'/scratch/project_2000527/pgnn/results/3res_{data_use}_eval_preds_train.csv')
    pd.DataFrame.from_dict(preds_test).to_csv(f'/scratch/project_2000527/pgnn/results/3res_{data_use}_eval_preds_test.csv')
