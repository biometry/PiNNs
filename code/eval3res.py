...
def eval2res(data_use='full', of=False, v=2):
    ...
    print(td, se, ae)
    pd.DataFrame.from_dict(td).to_csv(f'/scratch/project_2000527/pgnn/results/3res_{data_use}_eval_tloss.csv')
    pd.DataFrame.from_dict(se).to_csv(f'/scratch/project_2000527/pgnn/results/3res_{data_use}_eval_vseloss.csv')
    pd.DataFrame.from_dict(ae).to_csv(f'/scratch/project_2000527/pgnn/results/3res_{data_use}_eval_vaeloss.csv')
    ...
    pd.DataFrame.from_dict(performance).to_csv(f'/scratch/project_2000527/pgnn/results/3res_eval_{data_use}_performance.csv')
    pd.DataFrame.from_dict(preds_train).to_csv(f'/scratch/project_2000527/pgnn/results/3res_eval_preds_{data_use}_train.csv')
    pd.DataFrame.from_dict(preds_test).to_csv(f'/scratch/project_2000527/pgnn/results/3res_eval_preds_{data_use}_test.csv')
