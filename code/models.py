...
def sparameter_constraint(parameters):
    ...
    return p1.flatten() #torch.stack((p1.flatten()),dim=1)#, p2.flatten(), p3.flatten(), p4.flatten(), p5.flatten(), p6.flatten(), p7.flatten(), p8.flatten(), p9.flatten(), p10.flatten(), p11.flatten(), p12.flatten(), p13.flatten(), p14.flatten(), p15.flatten(), p16.flatten(), p17.flatten(), p18.flatten(), p19.flatten(), p20.flatten(), p21.flatten(), p22.flatten(), p23.flatten(), p24.flatten(), p25.flatten(), p26.flatten(), p27.flatten()), dim=1)



def sphysical_forward(parameters, input_data, tp=None, sw=None):

    # extract Parameters
    p1 = torch.tensor(413, dtype=torch.float64) #torch.mean(parameters[..., 0:1], dtype=torch.float64) + 413
    ...
    p9 = torch.tensor(-0.1027, dtype=torch.float64) #torch.mean(parameters[..., 8:9], dtype=torch.float64) #torch.tensor(-0.130473, dtype=torch.float64) #torch.mean(parameters[..., 8:9], dtype=torch.float64)
    ...
    p11 = torch.tensor(0.7779, dtype=torch.float64) #torch.mean(parameters[..., 10:11], dtype=torch.float64) #torch.tensor(0.450828, dtype=torch.float64) #torch.mean(parameters[..., 10:11], dtype=torch.float64)
    p12 = torch.tensor(0.5, dtype=torch.float64) #torch.mean(parameters[..., 11:12], dtype=torch.float64)
    p13 = torch.tensor(-0.364, dtype=torch.float64) #torch.mean(parameters[..., 12:13], dtype=torch.float64)
    p14 = torch.tensor(0.2715, dtype=torch.float64) #torch.mean(parameters[..., 13:14], dtype=torch.float64)*10 #torch.tensor(0.324463, dtype=torch.float64) #torch.mean(parameters[..., 13:14], dtype=torch.float64)*10
    p15 = torch.tensor(0.8351, dtype=torch.float64) #torch.mean(parameters[..., 14:15], dtype=torch.float64)
    p16 = torch.tensor(0.07348, dtype=torch.float64) #torch.mean(parameters[..., 15:16], dtype=torch.float64)
    p17 = torch.tensor(0.9996, dtype=torch.float64) #torch.mean(parameters[..., 16:17], dtype=torch.float64)
    p18 = torch.tensor(0.4428, dtype=torch.float64) #torch.mean(parameters[..., 17:18], dtype=torch.float64)*5
