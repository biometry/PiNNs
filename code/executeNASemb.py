...
# architecture grid
arch_grid = NASemb.ArchitectureSearchSpace(x.shape[1], y.shape[1], 200, 5)


# architecture search
layersizes = NASemb.ArchitectureSearch(arch_grid, parameters={'epochs': 300, 'batchsize': 8, 'learningrate':0.001}, X=x, Y=y, Xn=xn)
