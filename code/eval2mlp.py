...
mlp_hp = pd.read_csv("2mlp_lr.csv")
a = mlp_hp.loc[mlp_hp.val_loss.idxmin()][1:3]
b = a.to_numpy()
lr = b[0]
print(lr)
...
print(td, se, ae)
pd.DataFrame.from_dict(td).to_csv('2mlp_eval_tloss.csv')
pd.DataFrame.from_dict(se).to_csv('2mlp_eval_vseloss.csv')
pd.DataFrame.from_dict(ae).to_csv('2mlp_eval_vaeloss.csv')
