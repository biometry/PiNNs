...
def ft2res2(data_use='full'):
    ...
    res_as = pd.read_csv(f"/scratch/project_2000527/pgnn/results/EX2_res2AS_{data_use}.csv")
    ...
    res_hp = pd.read_csv(f"/scratch/project_2000527/pgnn/results/EX2_res2HP_{data_use}.csv")
