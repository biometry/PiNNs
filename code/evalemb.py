...
pd.DataFrame({"f1": t1, "f2": t2, "f3":t3, "f4": t4, "f5": t5, "f6": t6}).to_csv('emb_trainloss.csv')
v1 = []
v2 = []
v3 = []
v4 = []
...
pd.DataFrame({"f1": v1, "f2": v2, "f3":v3, "f4": v4, "f5": v5, "f6": v6}).to_csv('emb_vloss.csv')
...
pd.DataFrame.from_dict(performance).to_csv('emb_2eval_performance.csv')
pd.DataFrame.from_dict(preds_tr).to_csv('emb_2eval_preds_train.csv')
pd.DataFrame.from_dict(preds_te).to_csv('emb_2eval_preds_test.csv')
pd.DataFrame.from_dict(parameters_tr).to_csv('emb_2parameters_train.csv')
pd.DataFrame.from_dict(parameters_te).to_csv('emb_2parameters_test.csv')
