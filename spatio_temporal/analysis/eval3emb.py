...
def eval3emb(data_use="full"):
    ...
    print(td, se, ae)
    pd.DataFrame.from_dict(td).to_csv(f'spatio_temporal/results/3emb_{data_use}_eval_tloss.csv')
    pd.DataFrame.from_dict(se).to_csv(f'spatio_temporal/results/3emb_{data_use}_eval_vseloss.csv')
    pd.DataFrame.from_dict(ae).to_csv(f'spatio_temporal/results/3emb_{data_use}_eval_vaeloss.csv')
    ...
    pd.DataFrame.from_dict(performance).to_csv(f'spatio_temporal/results/3emb_{data_use}_performance.csv')
    pd.DataFrame.from_dict(preds_train).to_csv(f'spatio_temporal/results/3emb_eval_preds_{data_use}_train.csv')
    pd.DataFrame.from_dict(preds_test).to_csv(f'spatio_temporal/results/3emb_eval_preds_{data_use}_test.csv')
